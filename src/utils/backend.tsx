...
//           url: "me";
//           method: {
//             GET: { res: BackendResponse<SupabaseUser> };
//           };
//         },
//         {
//           url: ":id";
//           method: {
//             GET: { res: BackendResponse<SupabaseAllowFieldsUser> };
//           };
//         },
//       ];
//     },
...
//           url: "spins";
//           method: {
//             POST: { res: BackendResponse<SupabaseSpin> };
//           };
//           subs: [
//             {
//               url: "bets";
//               method: {
//                 GET: { res: BackendResponse<number[]> };
//               };
//               query: {
//                 count?: number;
//               };
...
//               url: ":key";
//               method: {
//                 GET: { res: BackendResponse<SupabaseStatsView[]> };
//               };
//             },
//           ];
//         },
...
//           url: "patterns";
//           method: {
//             GET: { res: BackendResponse<PatternWithPayouts[]> };
//           };
//           subs: [
//             {
//               url: ":id";
...
//           url: "";
//           method: {
//             POST: { res: BackendResponse<SupabaseShare> };
//           };
//         },
//         {
//           url: ":id";
//           method: {
//             GET: { res: BackendResponse<SupabaseShare> };
//           };
//         },
//       ];
//     },
...
export const postSpins = (token: string, bet: number) =>
...
export const getBets = () => {
  return fetcher<BackendResponse<number[]>>(
    `${NEXT_PUBLIC_BACKEND_URL}/v1/game/spins/bets`,
  );
};
